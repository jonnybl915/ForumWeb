...
public class Main {
    ...
    public static void insertMessage(Connection conn, int replyId, String text, int user_id) throws SQLException {
    ...
    public static ArrayList<Message> selectReplies(Connection conn, int reply_id) throws SQLException {
        ...
        while (results.next()) {
            ...
            String text = results.getString("messages.text");
            String author = results.getString("users.name");
            Message msg = new Message(id, reply_id, author, text);
            msgs.add(msg);
        }
        return msgs;
    }
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Spark.post(
                ...
                (request, response) -> {
                    ...
                    //validating id so that you can only delete posts that you create
                    Session session = request.session();
                    String username = session.attribute("username");
